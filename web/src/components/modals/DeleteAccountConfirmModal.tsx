            ...
            <Grid container spacing={2} columns={16}>
              <Grid item xs>
                <div style={styles.text}>
                  <HeadLine2
                    text={"deleteAccountConfirmModal.deleteYour"}
                    color={theme.palette.error.main}
                  />
                </div>
                <div style={styles.text}>
                  <HeadLine2
                    text={"deleteAccountConfirmModal.account"}
                    color={theme.palette.error.main}
                  />
                </div>
                ...
                <div style={styles.text2}>
                  <ParagraphBold
                    text={"deleteAccountConfirmModal.subText1"}
                    color={theme.palette.error.main}
                  />
                </div>
                <div style={styles.text}>
                  <ParagraphBold
                    text={"deleteAccountConfirmModal.subText2"}
                    color={theme.palette.error.main}
                  />
                </div>
                ...
                <div style={styles.text}>
                  <ParagraphBold
                    text={"deleteAccountConfirmModal.subText3"}
                    color={theme.palette.error.main}
                  />
                </div>
              </Grid>
              <Formik
                initialValues={DeleteAccountConfirmationInitialValues}
                validationSchema={DeleteAccountConfirmationValidationSchema}
                onSubmit={(values) => {
                ...
                {({ errors, touched, handleChange, handleBlur, values }) => (
                  <Form>
                    <Grid item xs>
                      ...
                      >
                        <PasswordInputField
                          label={"passwordInputField.password"}
                          placeholder={"passwordInputField.enterPassword"}
                          name="password"
                      ...
                      >
                        ...
                        >
                          <ContainedButton
                            title={"containedButtonTitles.deleteAccount"}
